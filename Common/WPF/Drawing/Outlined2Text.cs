...
namespace WPF.Drawing;

public class Outlined2Text : FrameworkElement, IAddChild
{
    /// <summary>
    ...
    public ushort OuterStrokeThickness
    {
        get => (ushort)GetValue(OuterStrokeThicknessProperty);
    ...
    protected override void OnRender(DrawingContext drawingContext)
    {
        ...
        // OUTER outline (draw first)
        if (OuterStrokeThickness > 0)
        {
            drawingContext.DrawGeometry(
                null,
                new Pen(OuterStroke, OuterStrokeThickness)
                {
